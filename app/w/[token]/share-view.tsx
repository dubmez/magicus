...
// ─── Page body ─────────────────────────────────────────────────────────────
// Default export: the interactive view of a share. The RSC wrapper at
// page.tsx hands us the already-fetched settings, so this component has
// no data-loading concerns of its own.
export default function ShareView({ settings }: { settings: ShareSettings }) {
